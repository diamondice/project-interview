...
export default [
  {
    ...
    children: [
      {
        path: 'list',
        component: _import('interview/pages/companys'),
        name: 'companys-list',
  ...
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: _import('interview/pages/questions'),
        name: 'questions-list',
        meta: { title: '基础题库', noCache: true, icon: 'component' }
      },
      {
        path: 'choice',
        component: _import('interview/pages/questions-choice'),
        name: 'questions-choice',
        meta: { title: '精选题库', noCache: true, icon: 'component' }
      },
      {
        path: 'new',
        component: _import('interview/pages/questions-new'),
        name: 'questions-new',
        meta: { title: '试题录入', noCache: true, icon: 'component' }
      },
      {
        path: 'randoms',
        component: _import('interview/pages/questions-randoms'),
  ...
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: _import('interview/pages/subjects'),
        name: 'subjects-list',
        meta: { title: '学科', noCache: true, icon: 'component' }
      },
      {
        path: 'directorys',
        component: _import('interview/pages/directorys'),
        name: 'subjects-directorys',
        meta: { title: '目录', noCache: true, icon: 'component' }
      },
      {
        path: 'tags',
        component: _import('interview/pages/tags'),
        name: 'subjects-tags',
  ...
  },
  {
    ...
    children: [
      {
        path: 'list',
        component: _import('interview/pages/articles'),
        name: 'articles-list',
